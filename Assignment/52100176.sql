...
(
  ...
  diaChi VARCHAR(30) NOT NULL,
  maSanPham VARCHAR(10) NOT NULL,
  CONSTRAINT FK_maSanPham_4 FOREIGN KEY (maSanPham) REFERENCES tBep(maSanPham)
)
...
VALUES
('NPP01', 'AVE GROUP', '0245733283', 'Q1, TP HCM', 'SP05'),
('NPP02', N'CDI Việt Nam', '0914274274', N'Hoàng Mai, TP Hà Nội', 'SP01'),
('NPP03', 'VINAMECO', '0866381357', N'Sơn Trà, TP Đà Nẵng', 'SP07'),
('NPP04', N'CÔNG TY TNHH HXC', '0736837817', N'Ninh Kiều, TP Cần Thơ', 'SP09')


INSERT INTO tBep
VALUES
('SP01', N'Đen', N'Bếp điện', N'Nhỏ'),
('SP05', N'Trắng',	N'Bếp từ', N'Lớn'),
('SP07', N'Đỏ', N'Bếp gas', N'Vừa'),
('SP09', N'Đen', N'Bếp hồng ngoại', N'Nhỏ')
